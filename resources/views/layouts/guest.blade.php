...
<link rel="icon" href="{{ isset($siteSettings['site_favicon']) && $siteSettings['site_favicon'] != '' ? asset($siteSettings['site_favicon']) : asset('favicon.ico') }}">

    <title>{{ $siteSettings['seo_meta_title'] ?? ($siteSettings['brand_name'] ?? 'Rumaindo') }}</title>
