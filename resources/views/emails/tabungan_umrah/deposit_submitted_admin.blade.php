...
@section('email_title', 'Setoran Tabungan Umrah Baru')
@section('title', 'Setoran Baru (Perlu Verifikasi)')

@section('content')
<p>Halo Admin,</p>
<p>Ada setoran Tabungan Umrah baru yang membutuhkan verifikasi.</p>
...
<p style="margin-top:14px;">
    Bukti pembayaran <b>dilampirkan</b> pada email ini (jika tersedia) dan juga dapat dibuka melalui Admin Panel.
</p>
@endsection
