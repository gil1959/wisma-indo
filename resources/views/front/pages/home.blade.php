...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-900 pt-20 pb-32">
    ...
    <div class="max-w-4xl mx-auto px-4 relative z-10 text-center w-full">
        <h1 class="text-4xl md:text-5xl lg:text-7xl font-extrabold text-white tracking-tight mb-6 leading-tight drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)]">
            {{ $heroTitle }}
        </h1>
        <p class="text-lg md:text-xl text-white mb-12 max-w-2xl mx-auto font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
            {{ $heroSubtitle }}
        </p>
