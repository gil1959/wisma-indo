...
'required_dates' => $isEn ? 'Visit date & participants are required.' : 'Tanggal kunjungan & peserta wajib diisi.',
];
@endphp
      ...
      <div class="space-y-3">
        ...
        <div class="grid sm:grid-cols-2 gap-3">
          ...
          <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
            ...
            <div class="text-sm font-bold text-slate-900" x-text="participants || '-'"></div>
          </div>
        </div>
...
<script>
  function restoranBookingPopup(basePrice, slug) {
    ...
    return {
      ...
      calc() {
        ...
        this.hours = this.participants;
        this.total = this.participants * this.base;
      },
