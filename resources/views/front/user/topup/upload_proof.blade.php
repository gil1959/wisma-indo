        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-200 mb-8 text-center">
                ...
                @if($transaction->unique_code)
                    <div class="text-3xl font-black text-[#0194F3] mb-1">Rp {{ number_format($transaction->total_amount, 0, ',', '.') }}</div>
                ...
                @else
                    <div class="text-3xl font-black text-[#0194F3] mb-4">Rp {{ number_format($transaction->price, 0, ',', '.') }}</div>
                @endif
            ...
            <form action="{{ route('topup.store_proof', $transaction->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-8">
