...
@section('title', 'Edit Kategori MICE')
@section('page-title', 'Edit Kategori MICE')
...
<div class="space-y-5">
    ...
    <form action="{{ route('admin.mice-categories.update', $category->id) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
