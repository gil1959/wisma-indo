...
@section('page-title', 'Tambah Paket Umrah')
...
<div class="space-y-5">
    ...
    <form action="{{ route('admin.umrah-packages.store') }}"
          method="POST"
          enctype="multipart/form-data"
          class="space-y-4">
        @csrf

        @include('admin.umrah-packages._form', ['package' => null, 'categories' => $categories])
