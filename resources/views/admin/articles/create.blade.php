        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="meta_title" class="w-full rounded-xl border-slate-300 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-2">SEO Description (Opsional)</label>
                    <textarea name="meta_desc" rows="3" class="w-full rounded-xl border-slate-300 text-sm"></textarea>
                </div>
            </div>
        </div>
    </form>
