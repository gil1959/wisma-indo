...
@section('title', 'Edit Kategori Umrah')
@section('page-title', 'Edit Kategori Umrah')
...
<div class="space-y-5">
    ...
    <form action="{{ route('admin.umrah-categories.update', $category) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
