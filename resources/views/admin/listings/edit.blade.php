...
<div class="py-6 min-h-screen bg-slate-50" x-data="listingForm()">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <form action="{{ route('admin.listings.update', $listing->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="listingDesc" class="w-full rounded-xl border-slate-200 hidden">{{ old('description', $listing->description) }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
                <h3 class="text-xl font-bold text-slate-800 mb-6 flex items-center gap-2">
                    ...
                    <input type="text" id="locationSearch" name="location" required value="{{ old('location', $listing->location) }}" class="w-full rounded-xl border-slate-200 focus:border-[#0194F3] focus:ring focus:ring-[#0194F3]/20" placeholder="Contoh: Jakarta Selatan">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="addressField" name="address" rows="3" class="w-full rounded-xl border-slate-200 focus:border-[#0194F3] focus:ring focus:ring-[#0194F3]/20" placeholder="Jalan, RT/RW, Kecamatan...">{{ old('address', $listing->address) }}</textarea>
                </div>v>
