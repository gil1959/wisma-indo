...
<div class="max-w-7xl mx-auto px-4 py-6">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-5">
        <div>
            ...
            <p class="text-sm text-slate-600 mt-1">Kelola kategori untuk paket rent car kamu.</p>
        </div>
                        ...
                        <tr class="hover:bg-slate-50/60 transition">
                            ...
                            <td class="px-5 py-3">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('partner.rent-car-categories.edit', $c) }}"
                                    ...
                                    <form action="{{ route('partner.rent-car-categories.destroy', $c) }}"
                                          method="POST"
