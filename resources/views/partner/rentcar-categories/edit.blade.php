...
<div class="max-w-3xl mx-auto px-4 py-6">
    <div class="mb-5">
        <a href="{{ route('partner.rent-car-categories.index') }}"
           class="inline-flex items-center gap-2 text-sm font-extrabold text-slate-700 hover:text-slate-900">
            <i data-lucide="arrow-left" class="w-4 h-4"></i>
            Kembali
        </a>
        <h1 class="text-xl sm:text-2xl font-extrabold text-slate-900 mt-3">Edit Kategori Rental</h1>
        <p class="text-sm text-slate-600 mt-1">Perbarui kategori untuk paket rent car.</p>
    </div>
    ...
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
        ...
        <form action="{{ route('partner.rent-car-categories.update', $category) }}"
              method="POST"
