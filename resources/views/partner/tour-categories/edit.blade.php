...
<div class="max-w-3xl mx-auto px-4 py-6">
    <div class="mb-5">
        <h1 class="text-xl sm:text-2xl font-extrabold text-slate-900">Edit Kategori Tour</h1>
        <p class="text-sm text-slate-600 mt-1">Perbarui kategori/subkategori.</p>
    </div>

    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm p-5">
        <form method="POST" action="{{ route('partner.tour-categories.update', $category) }}" class="space-y-4">
            @csrf
            @method('PUT')
