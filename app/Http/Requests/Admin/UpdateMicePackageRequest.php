...
class UpdateMicePackageRequest extends FormRequest
{
    public function authorize(): bool { return true; }

    public function rules(): array
    {
        $id = $this->route('mice_package')?->id
            ?? $this->route('micePackage')?->id
            ?? null;
        ...
        return [
            ...
            'slug' => 'required|string|max:255|unique:mice_packages,slug,' . $id,
