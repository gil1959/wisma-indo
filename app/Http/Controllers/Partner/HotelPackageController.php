...
class HotelPackageController extends Controller
{
    ...
    {
        abort_unless(auth()->user()->partner_type === 'agency_hotel_vila', 403);
        ...
        return view('partner.hotel.index', compact('packages'));
    }

    public function create()
    {
        abort_unless(auth()->user()->partner_type === 'agency_hotel_vila', 403);
        return view('partner.hotel.create');
    }
    ...
    public function edit(HotelPackage $hotel_package)
    {
        ...
        return view('partner.hotel.edit', compact('package'));
    }
