...
class TabunganUmrahDepositApprovedUserMail extends Mailable
{
    ...
    {
        $mail = $this->subject('[Tabungan Umrah] Setoran Disetujui')
            ->view('emails.tabungan_umrah.deposit_approved_user');
