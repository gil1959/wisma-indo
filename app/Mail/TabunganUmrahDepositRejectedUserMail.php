...
class TabunganUmrahDepositRejectedUserMail extends Mailable
{
    ...
    {
        $mail = $this->subject('[Tabungan Umrah] Setoran Ditolak')
            ->view('emails.tabungan_umrah.deposit_rejected_user');
